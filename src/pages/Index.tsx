    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-purple-50 dark:bg-purple-950/30 rounded-full border border-purple-200 dark:border-purple-800">
              ...
              <h1 className="text-5xl lg:text-6xl font-extralight text-slate-900 dark:text-white leading-tight">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-rose-500 font-light"> fluidez total</span>
              </h1>
            ...
            <div className="pt-4">
              <Button 
                ...
                className="bg-gradient-to-r from-purple-600 via-pink-500 to-rose-500 hover:from-purple-700 hover:via-pink-600 hover:to-rose-600 text-white px-8 py-3 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 text-lg"
                size="lg"
              >
                Comece seu fluxo
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4 pl-8">
                    <div className="w-20 h-12 bg-gradient-to-r from-purple-400 to-purple-500 rounded-lg flex items-center justify-center shadow-sm">
                  ...
                  <div className="flex items-center space-x-4 pl-4">
                    <div className="w-16 h-16 bg-gradient-to-r from-pink-400 to-rose-500 rounded-lg flex items-center justify-center shadow-sm transform rotate-45">
                  ...
                  {/* Step 3 */}
                  <div className="flex items-center space-x-4 pl-8">
                    <div className="w-16 h-12 bg-gradient-to-r from-indigo-400 to-indigo-500 rounded-lg flex items-center justify-center shadow-sm">
                ...
                <div className="absolute -bottom-6 -left-6 w-6 h-6 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-40 animate-pulse delay-1000"></div>
              </div>
            </div>
            
            {/* Background Decoration */}
            <div className="absolute -z-10 top-8 left-8 w-72 h-72 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-full blur-3xl opacity-60"></div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-24">
          ...
          <div className="text-center p-8 group">
            <div className="w-16 h-16 bg-gradient-to-br from-rose-100 to-pink-100 dark:from-rose-900/30 dark:to-pink-900/30 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
