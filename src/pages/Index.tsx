      ...
      <main className="container mx-auto px-6 py-20">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-4">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-3 font-light">
                Gratuito • Cadastre-se em segundos
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-24">
          ...
          <div className="text-center p-8 group">
            ...
            <h3 className="text-xl font-light text-slate-900 dark:text-white mb-3">Projetos Salvos</h3>
            <p className="text-slate-600 dark:text-slate-300 font-light leading-relaxed">Seus projetos ficam salvos na nuvem e acessíveis de qualquer lugar</p>
          </div>
